...
describe('User Model Unit Tests:', function () {
  ...
  describe('Method Save', function () {
    ...
    it('should not be able to save another user with the same email/username', function (done) {
  ...
  describe('User E-mail/Username Validation Tests', function() {
    it('should not allow invalid email address/username - "123"', function (done) {
      var _user1 = new User(user1);
    ...
    it('should not allow invalid email address/username - "123.com"', function (done) {
      var _user1 = new User(user1);

      _user1.username = '123.com';
      _user1.save(function (err) {
        if (!err) {
          _user1.remove(function (err_remove) {
            should.exist(err);
    ...
    it('should not allow invalid email address/username - "abc@abc@abc.com"', function (done) {
      var _user1 = new User(user1);

      _user1.username = 'abc@abc@abc.com';
      _user1.save(function (err) {
        if (!err) {
          _user1.remove(function (err_remove) {
            should.exist(err);
    ...
    it('should not allow invalid characters in email address/username - "abc~@#$%^&*()ef=@abc.com"', function (done) {
      var _user1 = new User(user1);

      _user1.username = 'abc~@#$%^&*()ef=@abc.com';
      _user1.save(function (err) {
        if (!err) {
          _user1.remove(function (err_remove) {
            should.exist(err);
    ...
    it('should not allow space characters in email address/username - "abc def@abc.com"', function (done) {
      var _user1 = new User(user1);

      _user1.username = 'abc def@abc.com';
      _user1.save(function (err) {
        if (!err) {
          _user1.remove(function (err_remove) {
            should.exist(err);
    ...
    it('should not allow doudble quote characters in email address/username - "abc\"def@abc.com"', function (done) {
      var _user1 = new User(user1);
    ...
    it('should not allow double dotted characters in email address/username - "abcdef@abc..com"', function (done) {
      var _user1 = new User(user1);

      _user1.username = 'abcdef@abc..com';
      _user1.save(function (err) {
        if (err) {
          _user1.remove(function (err_remove) {
            should.exist(err);
    ...
    it('should allow single quote characters in email address/username - "abc\'def@abc.com"', function (done) {
      var _user1 = new User(user1);
    ...
    it('should allow valid email address/username - "abc@abc.com"', function (done) {
      var _user1 = new User(user1);

      _user1.username = 'abc@abc.com';
      _user1.save(function (err) {
        if (!err) {
          _user1.remove(function (err_remove) {
            should.not.exist(err);
    ...
    it('should allow valid email address/username - "abc+def@abc.com"', function (done) {
      var _user1 = new User(user1);
    ...
    it('should allow valid email address/username - "abc.def@abc.def.com"', function (done) {
      var _user1 = new User(user1);

      _user1.username = 'abc.def@abc.def.com';
      _user1.save(function (err) {
        if (!err) {
          _user1.remove(function (err_remove) {
            should.not.exist(err);
